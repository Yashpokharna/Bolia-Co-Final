...
// import ShirtIconIcon from "@mui/icons-material/ShirtIconIcon";
...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      subtitle: "Audit",
      desc: "We cover Domestic and Foreign company setup in India & vice e versa.",
  ...
  icon: SparklesIcon,
  title: "Generative AI",
  subtitle: "Innovation with Gen AI",
  desc: "Optimised Ai Driven Solution, Business Model transformation with managed services and risk management and upskilling.",
  color: "from-purple-500 to-pink-500",
  bgColor: "bg-purple-50",
},
