      ...
      <div className="container relative z-10 grid items-center gap-12 mx-auto lg:grid-cols-2 max-w-7xl">
        ...
        <div className="space-y-8">
          ...
          <div className="hero-badge">
            <div
              className={`inline-flex items-center gap-3 px-5 py-2.5 rounded-full border-2 ${
                theme === "dark"
          ...
          <div className="space-y-4 hero-title">
            <h1
              className={`text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black leading-[1.1] ${
          ...
          {/* Description */}
          <p
            className={`text-lg sm:text-xl leading-relaxed max-w-xl hero-subtitle ${
